...
public class RestoclubAPI implements API {
    ...
    public void createSinglePage(SinglePlaceActivity singlePlaceActivity, String response) {
        ...
        if (rip != null) {
            TextViewUtil.setTextViewText((TextView) singlePlaceActivity.findViewById(edu.amd.spbstu.sbpmap.R.id.res_name),
                    Html.fromHtml(rip.get(RestoclubParser.names[0])));
            TextViewUtil.setTextViewText((TextView) singlePlaceActivity.findViewById(edu.amd.spbstu.sbpmap.R.id.res_address),
                    Html.fromHtml(rip.get(RestoclubParser.names[1])));
            TextViewUtil.setTextViewText((TextView) singlePlaceActivity.findViewById(edu.amd.spbstu.sbpmap.R.id.res_phone),
                    Html.fromHtml(rip.get(RestoclubParser.names[2])));
            TextViewUtil.setTextViewText((TextView) singlePlaceActivity.findViewById(edu.amd.spbstu.sbpmap.R.id.res_bill),
                    Html.fromHtml(rip.get(RestoclubParser.names[3])));
            TextViewUtil.setTextViewText((TextView) singlePlaceActivity.findViewById(edu.amd.spbstu.sbpmap.R.id.res_hours),
